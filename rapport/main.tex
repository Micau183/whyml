...
\usepackage{hyperref}
\input{header}
\input{preambule}  % Assuming this includes your custom LaTeX settings
\usepackage{listings}  % Include listings package
\lstdefinelanguage{why3}{
morekeywords={function, predicate, axiom, lemma, goal, type, var, mutable, invariant, ensures, requires, modifies, returns, assert, if, then, else, match, with, while, do, done, for, to, downto, break, continue, try, raise, exception, in, begin, end, ghost, import, export, clone, axiomatize},
sensitive=true,
morecomment=[l]{//},
morecomment=[s]{/*}{*/},
morestring=[b]",
