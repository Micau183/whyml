...
\lstdefinelanguage{why3}{%
  morekeywords={function,predicate,lemma,module,use,end,as,fun,match,try,with,let,in,val,type,and,;;,'=',rec},
  morekeywords=[2]{if,then,else,ref,not,or,+,raise},%XXX'=>'?
  morekeywords=[3]{option,list,string,unit,bool,int,float},
  morekeywords=[4]{List,Int,Map,Append,Lmap,Hashtbl,Algo,Random},
  morestring=[b]",
  %  escapechar={_},
%  textcl=true,
%  escapeinside={_},
